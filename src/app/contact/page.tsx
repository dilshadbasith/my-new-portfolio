        ...
        <main className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="grid gap-4 w-full max-w-md">
                ...
                <div className="about-glass-card p-4 rounded-lg flex items-center gap-4 group hover:border-primary/50 transition-colors">
                    ...
                    <div>
                        ...
                        <div className="text-white font-mono text-sm">Earth / India</div>
                    </div>
                </div>
                ...
                <div className="flex gap-4 pt-2">
                    ...
                    <a href="#" className="bg-white/5 border border-white/10 p-4 rounded text-white/60 hover:text-white hover:bg-black/40 hover:border-primary/50 transition-all">
            ...
            <div className="relative order-1 lg:order-2">
                ...
                <div className="hero-glass-card p-6 md:p-8 rounded-xl border border-white/10 relative z-10 backdrop-blur-xl">
                    ...
                    <form className="space-y-6">
                        ...
                        <button 
                            type="button" 
                            className="w-full bg-primary text-white font-bold uppercase tracking-widest py-4 rounded hover:bg-primary/80 transition-all hover:shadow-[0_0_20px_rgba(37,140,244,0.4)] flex items-center justify-center gap-2 group cursor-pointer"
                        >
